...
func TestExtractResourceID(t *testing.T) {
	tests := []struct {
		...
		{
			name:   "valid runtime ARN",
			arn:    "arn:aws:bedrock-agentcore:us-west-2:123456789012:runtime/abc123",
			prefix: "runtime",
			want:   "abc123",
		},
		{
			name:   "valid gateway ARN",
			arn:    "arn:aws:bedrock-agentcore:us-west-2:123456789012:gateway/gw-99",
			prefix: "gateway",
			want:   "gw-99",
		},
		{
			name:   "no match",
			arn:    "arn:aws:bedrock-agentcore:us-west-2:123456789012:other/foo",
			prefix: "runtime",
			want:   "",
		},
		{
		...
		},
		{
			...
			arn:    "arn:aws:bedrock-agentcore:us-west-2:123456789012:runtime/abc/def",
			prefix: "runtime",
			want:   "abc/def",
		},
		{
			name:   "empty prefix matches first slash",
			arn:    "arn:aws:bedrock-agentcore:us-west-2:123456789012:runtime/abc",
			prefix: "",
			want:   "abc",
		},
	}
